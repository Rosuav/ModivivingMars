...
PlaceObj('ModItemMissionSponsorPreset', {
	...
	tech1 = "AdvancedMicroGMiningOperations",
	trait = "Genius",
}),
PlaceObj('ModItemMissionSponsorPreset', {
	Drone = 10,
	...
	SortKey = 1,
	StirlingGenerator = 3,
	anomaly_bonus_breakthrough = range(5, 5),
	anomaly_bonus_free_tech = range(5, 5),
	cargo = 100000,
	challenge_mod = 100,
	comment = "Mole",
	display_name = T(596287179511, --[[ModItemMissionSponsorPreset Default mole display_name]] "Mole"),
	funding = 40000,
	goal_1_param_1 = "Elevator",
	goal_2_param_1 = "10",
	goal_3_param_1 = "10000",
	group = "Default",
	id = "mole",
	initial_rockets = 4,
	initial_techs_unlocked = 5,
	pod_class = "DropPod",
	precious_metals_export_price = 35,
	research_points = 500,
	research_points_per_explored_sector = 250,
	reward_effect_1 = PlaceObj('SpawnRocketInOrbit', {
		'is_supply_pod', true,
		'cargo_list', {
			PlaceObj('RocketCargoItem', {
	...
	reward_effect_2 = PlaceObj('RewardTechBoost', {
		'Field', "ReconAndExpansion",
		'Amount', 50,
	}),
	...
	reward_effect_5 = PlaceObj('RewardPrefab', {
		'Amount', 1,
		'Prefab', "OmegaTelescope",
	}),
	rocket_class = "ZeusRocket",
	sponsor_goal_1 = "SingleBuilding",
	sponsor_goal_2 = "LandColonistsBySol",
	sponsor_goal_3 = "ReachOverallTerraforming",
	sponsor_goal_4 = "OneOfEachFactory",
	sponsor_goal_5 = "RefuelRocketInASol",
	tech1 = "LowGShaftDigging",
	tech2 = "UndergroundFlightSchool",
	tech3 = "MolePeople",
	tech4 = "UndergroundDomes",
	tech5 = "SuperiorPipes",
	trait = "Genius",
}),
}
